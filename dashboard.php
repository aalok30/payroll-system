                        ...
                        <li>
                            <a class="profile-pic" href="#">
                                <img src="plugins/images/users/varun.jpg" alt="user-img" width="36"
                                    class="img-circle"><span class="text-white font-medium"><?php echo $_SESSION['uname']; ?></span></a>
                        </li>
                    </ul>
                </div>
            </nav>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="fact_emp.php"
                                aria-expanded="false">
                        ...
                        <li class="text-center p-20 upgrade-btn">
                            <a href="login.php" class="btn d-grid btn-danger text-white">
                                Logout</a>
                        </li>
                    </ul>
